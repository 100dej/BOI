Public Class Frm401NetSales
    ...
    Private Sub cmdExec_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim x As String = String.Format("exec boi.dbo.NetSales_BOI_for_program '{0}','{1}'", xMonth, xYear)
...
GetError:
    ...
    Private Sub cmdExport2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        cdl.FileName = String.Format("Report Net Sales month {0} year {1}", xMonth, xYear)
