Public Class Frm301StockBalanceEnding
    ...
    Private Sub cmdExec_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim x As String = String.Format("exec boi.dbo.Stock_Ending_Report '{0}','{1}'", xMonth, xYear)
...
GetError:
    ...
    Private Sub cmdExport2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        cdl.FileName = String.Format("Report Stock balance end of month {0} year {1}", xMonth, xYear)
