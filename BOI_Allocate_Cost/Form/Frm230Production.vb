Public Class Frm230Production
    ...
    Private Sub cmdExec_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim x As String = String.Format("exec boi.dbo.Production_BOI_for_Program '{0}','{1}'", xMonth, xYear)
...
GetError:
    ...
    Private Sub cmdExport2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        cdl.FileName = String.Format("Report Production month {0} year {1}", xMonth, xYear)
